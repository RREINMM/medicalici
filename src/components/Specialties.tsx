...
export const Specialties = () => {
  return (
    <section className="py-24 px-4 bg-gradient-to-br from-[#0EA5E9] via-[#38BDF8] to-[#22C55E]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {formations.map((formation, index) => (
            <Card 
              key={index} 
              className="group relative overflow-hidden rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl bg-white/95 border-white/20"
            >
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0EA5E9]/80 to-transparent" />
                <div className="absolute top-4 left-4 bg-white p-3 rounded-lg shadow-md">
                  <formation.icon className="w-6 h-6 text-[#0EA5E9]" />
                </div>
              </div>
              <div className="p-6">
